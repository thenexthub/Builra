...
#ifndef BUILRA_TESTS_TEMPDIR
#define BUILRA_TESTS_TEMPDIR
...
private:
    ...
    toolchain::SmallString<256> tempDir;

public:
    TmpDir(toolchain::StringRef namePrefix = "");
    ~TmpDir();
