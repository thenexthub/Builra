...
//===----------------------------------------------------------------------===//
//
// These are the C API interfaces to the builra Ninja component.
//
//===----------------------------------------------------------------------===//

#ifndef BUILRA_PUBLIC_NINJA_H
#define BUILRA_PUBLIC_NINJA_H
...
} llb_ninja_variable_t BUILRA_SWIFT_NAME(CNinjaVariable);
...
} llb_ninja_rule_t BUILRA_SWIFT_NAME(CNinjaRule);
...
} llb_ninja_manifest_t BUILRA_SWIFT_NAME(CNinjaManifest);

/// Load a Ninja manifest at \p filename, resolving any relative paths using
/// \p working_dir.
BUILRA_EXPORT llb_ninja_manifest_t llb_manifest_fs_load(
...
BUILRA_EXPORT void llb_manifest_destroy(llb_ninja_manifest_t *manifest);
