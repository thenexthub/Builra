...
public:
  ...
  CAPIBuildDBFetchResult(const CAPIBuildDBFetchResult&) BUILRA_DELETED_FUNCTION;
  CAPIBuildDBFetchResult& operator=(const CAPIBuildDBFetchResult&) BUILRA_DELETED_FUNCTION;
