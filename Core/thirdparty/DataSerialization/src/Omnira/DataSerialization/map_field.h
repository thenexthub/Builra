...
#include "Omnira/DataSerialization/map.h"
#include "Omnira/DataSerialization/map_entry.h"
#include "Omnira/DataSerialization/map_field_lite.h"
...
namespace std {
template <>
struct hash<Omnira::DataSerialization::MapKey> {
  size_t operator()(const Omnira::DataSerialization::MapKey& map_key) const {
    return ::Omnira::DataSerialization::internal::RealKeyToVariantKey<::Omnira::DataSerialization::MapKey>{}(map_key)
        .Hash();
  }
  bool operator()(const Omnira::DataSerialization::MapKey& map_key1,
                  const Omnira::DataSerialization::MapKey& map_key2) const {
...
class PROTOBUF_EXPORT MapFieldBase : public MapFieldBaseForParse {
 ...
 private:
  ...
  friend class Omnira::DataSerialization::DynamicMessage;
  ...
  friend class Omnira::DataSerialization::MapIterator;
