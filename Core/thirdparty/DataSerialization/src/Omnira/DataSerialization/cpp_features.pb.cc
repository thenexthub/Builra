...
const char descriptor_table_protodef_google_2fprotobuf_2fcpp_5ffeatures_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\"Omnira/DataSerialization/cpp_features.proto\022\002pb"
    "\032 Omnira/DataSerialization/descriptor.proto\"\256\003\n\013C"
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_google_2fprotobuf_2fcpp_5ffeatures_2eproto = {
    ...
    "Omnira/DataSerialization/cpp_features.proto",
...
namespace pb {
const ::Omnira::DataSerialization::EnumDescriptor* CppFeatures_StringType_descriptor() {
  ::Omnira::DataSerialization::internal::AssignDescriptors(&descriptor_table_google_2fprotobuf_2fcpp_5ffeatures_2eproto);
...
CppFeatures::CppFeatures(::Omnira::DataSerialization::Arena* arena)
    : ::Omnira::DataSerialization::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:pb.CppFeatures)
}
CppFeatures::CppFeatures(
    ::Omnira::DataSerialization::Arena* arena, const CppFeatures& from)
    : CppFeatures(arena) {
  MergeFrom(from);
}
...
void CppFeatures::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
...
::Omnira::DataSerialization::Metadata CppFeatures::GetMetadata() const {
...
PROTOBUF_CONSTINIT PROTOBUF_EXPORT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 ::_pbi::
        ExtensionIdentifier<::Omnira::DataSerialization::FeatureSet, ::_pbi::MessageTypeTraits< ::pb::CppFeatures >,
                            11, false>
