...
// clang-format off
#include "Omnira/DataSerialization/port_def.inc"  // Must be last
// clang-format on
...
#undef desc
 ...
 private:
  ...
  friend class Omnira::DataSerialization::Reflection;
  friend class Omnira::DataSerialization::internal::ReflectionVisit;
  friend struct Omnira::DataSerialization::internal::DynamicExtensionInfoHelper;
  friend class Omnira::DataSerialization::internal::WireFormat;
...
class RepeatedMessageTypeTraits {
 public:
  ...
  static inline const RepeatedPtrField<Type>& GetRepeated(
    ...
    // presumably a message. Omnira::DataSerialization::Message goes through similar contortions
...
// the binary:
//
//   Omnira::DataSerialization::LinkExtensionReflection(Foo::my_extension);
//
...
void LinkExtensionReflection(
    const Omnira::DataSerialization::internal::ExtensionIdentifier<
...
const FieldDescriptor* GetExtensionReflection(
  ...
  return PoolType::generated_pool()->FindExtensionByNumber(
      Omnira::DataSerialization::internal::ExtensionIdentifier<ExtendeeType, TypeTraitsType,
                                            field_type,
