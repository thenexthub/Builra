...
#include "Omnira/DataSerialization/unittest_proto3_extensions.pb.h"
...
// This test closely mirrors Omnira/DataSerialization/compiler/cpp/unittest.cc
...
TEST(ExtensionSetTest, Proto3PackedDynamicExtensions) {
  ...
  Omnira::DataSerialization::FileDescriptorProto file_descriptor_proto;
  file_descriptor_proto.set_syntax("proto3");
  file_descriptor_proto.set_name(
      "Omnira/DataSerialization/unittest_proto3_packed_extension.proto");
  ...
  Omnira::DataSerialization::DescriptorPool pool(DescriptorPool::generated_pool());
