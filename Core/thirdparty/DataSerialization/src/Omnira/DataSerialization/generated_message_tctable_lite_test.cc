...
const char* FastParserGaveUp(::Omnira::DataSerialization::MessageLite*, const char* ptr,
                             ::Omnira::DataSerialization::internal::ParseContext*,
                             ::Omnira::DataSerialization::internal::TcFieldData data,
                             const ::Omnira::DataSerialization::internal::TcParseTableBase*,
                             uint64_t hasbits) {
