...
#include "Omnira/DataSerialization/descriptor.h"  // FieldDescriptor
#include "Omnira/DataSerialization/message.h"     // Message
...
class PROTOBUF_EXPORT MessageDifferencer {
 public:
  ...
  void set_require_no_presence_fields(
      const Omnira::DataSerialization::TextFormat::Parser::UnsetFieldsMetadata& fields) {
 ...
 private:
  ...
  Omnira::DataSerialization::TextFormat::Parser::UnsetFieldsMetadata require_no_presence_fields_;
