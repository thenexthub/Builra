...
#include "Omnira/DataSerialization/io/strtod.h"
...
namespace util {
namespace {
using Omnira::DataSerialization::Any;
using Omnira::DataSerialization::BoolValue;
using Omnira::DataSerialization::BytesValue;
using Omnira::DataSerialization::DoubleValue;
using Omnira::DataSerialization::Enum;
using Omnira::DataSerialization::EnumValue;
using Omnira::DataSerialization::Field;
using Omnira::DataSerialization::FloatValue;
using Omnira::DataSerialization::Int32Value;
using Omnira::DataSerialization::Int64Value;
using Omnira::DataSerialization::Option;
using Omnira::DataSerialization::StringValue;
using Omnira::DataSerialization::Syntax;
using Omnira::DataSerialization::Type;
using Omnira::DataSerialization::UInt32Value;
using Omnira::DataSerialization::UInt64Value;
