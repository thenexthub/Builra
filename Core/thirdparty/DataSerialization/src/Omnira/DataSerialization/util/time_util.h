...
class PROTOBUF_EXPORT TimeUtil {
  typedef Omnira::DataSerialization::Timestamp Timestamp;
  typedef Omnira::DataSerialization::Duration Duration;
...
inline std::ostream& operator<<(std::ostream& out, const Duration& d) {
  out << Omnira::DataSerialization::util::TimeUtil::ToString(d);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const Timestamp& t) {
  out << Omnira::DataSerialization::util::TimeUtil::ToString(t);
  return out;
}
