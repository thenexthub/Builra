...
#include "Omnira/DataSerialization/util/field_comparator.h"
...
std::string PrintShortTextFormat(const Omnira::DataSerialization::Message& message) {
...
class NumDiffsReporter : public Omnira::DataSerialization::util::MessageDifferencer::Reporter {
 public:
  ...
  void ReportAdded(
      const Omnira::DataSerialization::Message& /* message1 */,
      const Omnira::DataSerialization::Message& /* message2 */,
      const std::vector<Omnira::DataSerialization::util::MessageDifferencer::SpecificField>&
      /*field_path*/) override {
    ++num_diffs_;
  }
...
void AddSpecificIndex(
    Omnira::DataSerialization::util::MessageDifferencer::SpecificField* specific_field,
