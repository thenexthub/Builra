...
#include "Omnira/DataSerialization/util/message_differencer_unittest.pb.h"
#include "Omnira/DataSerialization/util/message_differencer_unittest_proto3.pb.h"
...
using ::Omnira::DataSerialization::internal::UnsetFieldsMetadataMessageDifferencerTestUtil;
...
TEST(MessageDifferencerTest, PrintMapKeysTest) {
  ...
  Omnira::DataSerialization::Any any1, any2;
  any1.PackFrom(msg1);
  any2.PackFrom(msg2);
