...
using Omnira::DataSerialization::Duration;
using Omnira::DataSerialization::Timestamp;
...
namespace DataSerialization {
namespace {
using ::Omnira::DataSerialization::util::CreateNormalized;
using ::Omnira::DataSerialization::util::kNanosPerSecond;
