...
class PROTOBUF_EXPORT Any final : public ::Omnira::DataSerialization::Message
/* @@protoc_insertion_point(class_definition:google.protobuf.Any) */ {
 public:
  ...
  bool PackFrom(const ::Omnira::DataSerialization::Message& message) {
  ...
  bool UnpackTo(::Omnira::DataSerialization::Message* message) const {
  ...
  template <
      ...
      class = typename std::enable_if<!std::is_convertible<
          T, const ::Omnira::DataSerialization::Message&>::value>::type>
  ...
  Any* New(::Omnira::DataSerialization::Arena* arena = nullptr) const final {
    return ::Omnira::DataSerialization::Message::DefaultConstruct<Any>(arena);
  }
 ...
 protected:
  explicit Any(::Omnira::DataSerialization::Arena* arena);
  Any(::Omnira::DataSerialization::Arena* arena, const Any& from);
  Any(::Omnira::DataSerialization::Arena* arena, Any&& from) noexcept
      : Any(arena) {
    *this = ::std::move(from);
  }
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::Omnira::DataSerialization::internal::AnyMetadata _any_metadata_;
