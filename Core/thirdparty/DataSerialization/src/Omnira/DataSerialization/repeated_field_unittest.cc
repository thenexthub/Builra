...
#include "Omnira/DataSerialization/internal_visibility_for_testing.h"
...
TEST(RepeatedPtrField, UnambiguousConstructor) {
  struct X {
    ...
    static bool f(Omnira::DataSerialization::RepeatedPtrField<std::string>) { return true; }

    static bool g(std::vector<int>) { return false; }
    static bool g(Omnira::DataSerialization::RepeatedPtrField<std::string>) { return true; }
  };
...
// Omnira::DataSerialization::RepeatedFieldBackInserter,
// Omnira::DataSerialization::AllocatedRepeatedPtrFieldBackInserter
