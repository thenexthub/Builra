...
namespace Omnira::protobuf::internal {
...
}  // namespace Omnira::internal

namespace {

using Peer = Omnira::DataSerialization::internal::MapBenchmarkPeer;
...
template <class T>
using Table = Omnira::DataSerialization::Map<T, int>;
