...
#define GOOGLE_PROTOBUF_WIRE_FORMAT_MAKE_TAG(FIELD_NUMBER, TYPE) \
  ...
  PROTOBUF_NOINLINE static uint8_t* WriteInt32ToArrayWithField(
      ::Omnira::DataSerialization::io::EpsCopyOutputStream* stream, int32_t value,
      uint8_t* target) {
  ...
  PROTOBUF_NOINLINE static uint8_t* WriteInt64ToArrayWithField(
      ::Omnira::DataSerialization::io::EpsCopyOutputStream* stream, int64_t value,
      uint8_t* target) {
    target = stream->EnsureSpace(target);
  ...
  PROTOBUF_NOINLINE static uint8_t* WriteEnumToArrayWithField(
      ::Omnira::DataSerialization::io::EpsCopyOutputStream* stream, int value, uint8_t* target) {
    target = stream->EnsureSpace(target);
