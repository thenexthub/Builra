...
#include "Omnira/DataSerialization/stubs/platform_macros.h"
#include "Omnira/DataSerialization/stubs/port.h"
...
#define GOOGLE_PROTOBUF_VERIFY_VERSION \
  ::Omnira::DataSerialization::internal::VerifyVersion(GOOGLE_PROTOBUF_VERSION, __FILE__)
