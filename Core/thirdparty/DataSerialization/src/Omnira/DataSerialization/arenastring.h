...
struct PROTOBUF_EXPORT ArenaStringPtr {
  ...
  void ClearToDefault(const LazyString& default_value, ::Omnira::DataSerialization::Arena* arena);
 ...
 private:
  ...
  friend class ::Omnira::DataSerialization::internal::SwapFieldHelper;
  ...
  std::string* MutableSlow(::Omnira::DataSerialization::Arena* arena, const Lazy&... lazy_default);
