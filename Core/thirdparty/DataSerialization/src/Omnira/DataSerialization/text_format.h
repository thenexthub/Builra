 ...
 public:
  ...
  class PROTOBUF_EXPORT Printer {
   ...
   private:
    ...
    friend class Omnira::DataSerialization::python::cmessage::PythonFieldValuePrinter;
  ...
  // Omnira::DataSerialization::MessageLite::ParseFromString().
   ...
   public:
    ...
    class UnsetFieldsMetadata {
     ...
     private:
      ...
      friend class ::Omnira::DataSerialization::internal::
          UnsetFieldsMetadataMessageDifferencerTestUtil;
      friend class ::Omnira::DataSerialization::internal::UnsetFieldsMetadataTextFormatTestUtil;
      friend class ::Omnira::DataSerialization::util::MessageDifferencer;
      friend class ::Omnira::DataSerialization::TextFormat::Parser;
    };
