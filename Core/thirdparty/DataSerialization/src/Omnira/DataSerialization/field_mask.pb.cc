...
const ::uint32_t
    TableStruct_google_2fprotobuf_2ffield_5fmask_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::FieldMask, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::FieldMask, _impl_.paths_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::Omnira::DataSerialization::FieldMask)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::Omnira::DataSerialization::_FieldMask_default_instance_._instance,
};
const char descriptor_table_protodef_google_2fprotobuf_2ffield_5fmask_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n Omnira/DataSerialization/field_mask.proto\022\017goog"
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_google_2fprotobuf_2ffield_5fmask_2eproto = {
    ...
    "Omnira/DataSerialization/field_mask.proto",
...
FieldMask::FieldMask(::Omnira::DataSerialization::Arena* arena)
...
inline PROTOBUF_NDEBUG_INLINE FieldMask::Impl_::Impl_(
    ...
    const Impl_& from, const ::Omnira::DataSerialization::FieldMask& from_msg)
...
const ::_pbi::TcParseTable<0, 1, 0, 39, 2> FieldMask::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::FieldMask>(),  // to_prefetch
...
::uint8_t* FieldMask::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_paths_size(); i < n; ++i) {
    ...
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.FieldMask.paths");
...
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.FieldMask)
  ...
  // repeated string paths = 1;
  total_size += 1 * ::Omnira::DataSerialization::internal::FromIntSize(_internal_paths().size());
...
void FieldMask::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
...
::Omnira::DataSerialization::Metadata FieldMask::GetMetadata() const {
