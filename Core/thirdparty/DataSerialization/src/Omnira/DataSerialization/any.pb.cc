...
// source: Omnira/DataSerialization/any.proto
...
const ::uint32_t
    TableStruct_google_2fprotobuf_2fany_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Any, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Any, _impl_.type_url_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Any, _impl_.value_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::Omnira::DataSerialization::Any)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::Omnira::DataSerialization::_Any_default_instance_._instance,
};
const char descriptor_table_protodef_google_2fprotobuf_2fany_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\031Omnira/DataSerialization/any.proto\022\017google.prot"
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_google_2fprotobuf_2fany_2eproto = {
    ...
    "Omnira/DataSerialization/any.proto",
...
bool Any::GetAnyFieldDescriptors(
    const ::Omnira::DataSerialization::Message& message,
    const ::Omnira::DataSerialization::FieldDescriptor** type_url_field,
    const ::Omnira::DataSerialization::FieldDescriptor** value_field) {
...
Any::Any(::Omnira::DataSerialization::Arena* arena)
...
inline PROTOBUF_NDEBUG_INLINE Any::Impl_::Impl_(
    ...
    const Impl_& from, const ::Omnira::DataSerialization::Any& from_msg)
...
const ::_pbi::TcParseTable<1, 2, 0, 36, 2> Any::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Any>(),  // to_prefetch
...
::uint8_t* Any::_InternalSerialize(
  ...
  if (!this->_internal_type_url().empty()) {
    ...
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Any.type_url");
...
void Any::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
...
::Omnira::DataSerialization::Metadata Any::GetMetadata() const {
