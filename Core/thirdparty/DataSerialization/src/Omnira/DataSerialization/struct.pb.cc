...
const ::uint32_t
    TableStruct_google_2fprotobuf_2fstruct_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Struct_FieldsEntry_DoNotUse, _has_bits_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Struct_FieldsEntry_DoNotUse, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Struct_FieldsEntry_DoNotUse, key_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Struct_FieldsEntry_DoNotUse, value_),
        0,
        1,
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Struct, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Struct, _impl_.fields_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Value, _internal_metadata_),
        ~0u,  // no _extensions_
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Value, _impl_._oneof_case_[0]),
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        ...
        ::_pbi::kInvalidFieldOffsetTag,
        ::_pbi::kInvalidFieldOffsetTag,
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Value, _impl_.kind_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::ListValue, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::ListValue, _impl_.values_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, 10, -1, sizeof(::Omnira::DataSerialization::Struct_FieldsEntry_DoNotUse)},
        {12, -1, -1, sizeof(::Omnira::DataSerialization::Struct)},
        {21, -1, -1, sizeof(::Omnira::DataSerialization::Value)},
        {36, -1, -1, sizeof(::Omnira::DataSerialization::ListValue)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::Omnira::DataSerialization::_Struct_FieldsEntry_DoNotUse_default_instance_._instance,
    &::Omnira::DataSerialization::_Struct_default_instance_._instance,
    &::Omnira::DataSerialization::_Value_default_instance_._instance,
    &::Omnira::DataSerialization::_ListValue_default_instance_._instance,
};
const char descriptor_table_protodef_google_2fprotobuf_2fstruct_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\034Omnira/DataSerialization/struct.proto\022\017google.p"
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_google_2fprotobuf_2fstruct_2eproto = {
    ...
    "Omnira/DataSerialization/struct.proto",
...
namespace Omnira {
namespace DataSerialization {
const ::Omnira::DataSerialization::EnumDescriptor* NullValue_descriptor() {
  ::Omnira::DataSerialization::internal::AssignDescriptors(&descriptor_table_google_2fprotobuf_2fstruct_2eproto);
...
Struct_FieldsEntry_DoNotUse::Struct_FieldsEntry_DoNotUse(::Omnira::DataSerialization::Arena* arena) : SuperType(arena) {}
...
Struct::Struct(::Omnira::DataSerialization::Arena* arena)
...
inline PROTOBUF_NDEBUG_INLINE Struct::Impl_::Impl_(
    ...
    const Impl_& from, const ::Omnira::DataSerialization::Struct& from_msg)
...
const ::_pbi::TcParseTable<0, 1, 2, 37, 2> Struct::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Struct>(),  // to_prefetch
    ...
    {::_pbi::TcParser::GetMapAuxInfo<
        ...
        1, 0, 0, 9,
        11)},
    {::_pbi::TcParser::CreateInArenaStorageCb<::Omnira::DataSerialization::Value>},
  }}, {{
    "\26\6\0\0\0\0\0\0"
...
::uint8_t* Struct::_InternalSerialize(
  ...
  if (!_internal_fields().empty()) {
    using MapType = ::Omnira::DataSerialization::Map<std::string, ::Omnira::DataSerialization::Value>;
    using WireHelper = _pbi::MapEntryFuncs<std::string, ::Omnira::DataSerialization::Value,
 ...
 ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Struct.fields");
      }
    } else {
...
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.Struct)
  ...
  // map<string, .google.protobuf.Value> fields = 1;
  total_size += 1 * ::Omnira::DataSerialization::internal::FromIntSize(_internal_fields_size());
  for (const auto& entry : _internal_fields()) {
    total_size += _pbi::MapEntryFuncs<std::string, ::Omnira::DataSerialization::Value,
                                   _pbi::WireFormatLite::TYPE_STRING,
...
void Struct::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
...
::Omnira::DataSerialization::Metadata Struct::GetMetadata() const {
...
class Value::_Internal {
 public:
  static constexpr ::int32_t kOneofCaseOffset =
      PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Value, _impl_._oneof_case_);
};

void Value::set_allocated_struct_value(::Omnira::DataSerialization::Struct* struct_value) {
  ::Omnira::DataSerialization::Arena* message_arena = GetArena();
  clear_kind();
  if (struct_value) {
    ::Omnira::DataSerialization::Arena* submessage_arena = struct_value->GetArena();
    if (message_arena != submessage_arena) {
      struct_value = ::Omnira::DataSerialization::internal::GetOwnedMessage(message_arena, struct_value, submessage_arena);
    }
...
void Value::set_allocated_list_value(::Omnira::DataSerialization::ListValue* list_value) {
  ::Omnira::DataSerialization::Arena* message_arena = GetArena();
  clear_kind();
  if (list_value) {
    ::Omnira::DataSerialization::Arena* submessage_arena = list_value->GetArena();
    if (message_arena != submessage_arena) {
      list_value = ::Omnira::DataSerialization::internal::GetOwnedMessage(message_arena, list_value, submessage_arena);
    }
    set_has_list_value();
...
Value::Value(::Omnira::DataSerialization::Arena* arena)
    : ::Omnira::DataSerialization::Message(arena) {
  SharedCtor(arena);
...
inline PROTOBUF_NDEBUG_INLINE Value::Impl_::Impl_(
    ::Omnira::DataSerialization::internal::InternalVisibility visibility, ::Omnira::DataSerialization::Arena* arena,
    const Impl_& from, const ::Omnira::DataSerialization::Value& from_msg)
      : kind_{},
        _cached_size_{0},
  ...
  switch (kind_case()) {
    case KIND_NOT_SET:
      ...
      case kBoolValue:
        ...
        break;
      case kStructValue:
        _impl_.kind_.struct_value_ = ::Omnira::DataSerialization::Message::CopyConstruct<::Omnira::DataSerialization::Struct>(arena, *from._impl_.kind_.struct_value_);
        break;
      case kListValue:
        _impl_.kind_.list_value_ = ::Omnira::DataSerialization::Message::CopyConstruct<::Omnira::DataSerialization::ListValue>(arena, *from._impl_.kind_.list_value_);
        break;
  }
...
const ::_pbi::TcParseTable<0, 6, 2, 42, 2> Value::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Value>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    ...
    {::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Struct>()},
    {::_pbi::TcParser::GetTable<::Omnira::DataSerialization::ListValue>()},
  }}, {{
    "\25\0\0\14\0\0\0\0"
...
::uint8_t* Value::_InternalSerialize(
  ...
  switch (kind_case()) {
    ...
    case kStringValue: {
      ...
      ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Value.string_value");
...
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.Value)
  ...
  switch (kind_case()) {
    ...
    case kStructValue: {
      total_size +=
          1 + ::Omnira::DataSerialization::internal::WireFormatLite::MessageSize(*_impl_.kind_.struct_value_);
      break;
    }
    // .google.protobuf.ListValue list_value = 6;
    case kListValue: {
      total_size +=
          1 + ::Omnira::DataSerialization::internal::WireFormatLite::MessageSize(*_impl_.kind_.list_value_);
      break;
    }
    case KIND_NOT_SET: {
      break;
...
void Value::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
      ...
      case kStructValue: {
        if (oneof_needs_init) {
          _this->_impl_.kind_.struct_value_ =
              ::Omnira::DataSerialization::Message::CopyConstruct<::Omnira::DataSerialization::Struct>(arena, *from._impl_.kind_.struct_value_);
        } else {
      ...
      case kListValue: {
        if (oneof_needs_init) {
          _this->_impl_.kind_.list_value_ =
              ::Omnira::DataSerialization::Message::CopyConstruct<::Omnira::DataSerialization::ListValue>(arena, *from._impl_.kind_.list_value_);
        } else {
...
::Omnira::DataSerialization::Metadata Value::GetMetadata() const {
  return ::Omnira::DataSerialization::Message::GetMetadataImpl(GetClassData()->full());
}
// ===================================================================
...
ListValue::ListValue(::Omnira::DataSerialization::Arena* arena)
    : ::Omnira::DataSerialization::Message(arena) {
  SharedCtor(arena);
...
inline PROTOBUF_NDEBUG_INLINE ListValue::Impl_::Impl_(
    ::Omnira::DataSerialization::internal::InternalVisibility visibility, ::Omnira::DataSerialization::Arena* arena,
    const Impl_& from, const ::Omnira::DataSerialization::ListValue& from_msg)
...
const ::_pbi::TcParseTable<0, 1, 1, 0, 2> ListValue::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::ListValue>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    ...
    {::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Value>()},
  }}, {{
  }},
};
...
void ListValue::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
...
::Omnira::DataSerialization::Metadata ListValue::GetMetadata() const {
  return ::Omnira::DataSerialization::Message::GetMetadataImpl(GetClassData()->full());
}
