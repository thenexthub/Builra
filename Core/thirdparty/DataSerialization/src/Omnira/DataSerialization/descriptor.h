...
class PROTOBUF_EXPORT SymbolBase {
 private:
  friend class Omnira::DataSerialization::Symbol;
...
class PROTOBUF_EXPORT InternalFeatureHelper {
 ...
 private:
  friend class ::Omnira::DataSerialization::compiler::CodeGenerator;
  friend class ::Omnira::DataSerialization::compiler::CommandLineInterface;
...
class PROTOBUF_EXPORT DescriptorPool {
 ...
 private:
  ...
  friend class DescriptorBuilder;
  friend class FileDescriptorTables;
  friend class Omnira::DataSerialization::descriptor_unittest::ValidationErrorTest;
  friend class ::Omnira::DataSerialization::compiler::CommandLineInterface;
