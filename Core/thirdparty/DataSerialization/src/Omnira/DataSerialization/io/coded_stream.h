...
class PROTOBUF_EXPORT CodedInputStream {
 ...
 private:
  ...
  friend class Omnira::DataSerialization::ZeroCopyCodedInputStream;
  friend class Omnira::DataSerialization::internal::EpsCopyByteStream;
};
...
class PROTOBUF_EXPORT CodedOutputStream {
 ...
 private:
  ...
  // thread has done so.
  friend void Omnira::DataSerialization::internal::MapTestForceDeterministic();
