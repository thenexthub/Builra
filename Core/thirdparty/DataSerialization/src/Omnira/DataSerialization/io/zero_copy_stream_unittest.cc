...
#if HAVE_ZLIB
#include "Omnira/DataSerialization/io/gzip_stream.h"
#endif
...
using Omnira::DataSerialization::io::win32::access;
using Omnira::DataSerialization::io::win32::close;
using Omnira::DataSerialization::io::win32::mkdir;
using Omnira::DataSerialization::io::win32::open;
#endif
...
TEST_F(IoTest, CompressionOptions) {
  ...
  std::string golden_filename =
      TestUtil::GetTestDataPath("Omnira/DataSerialization/testdata/golden_message");
  std::string golden;
