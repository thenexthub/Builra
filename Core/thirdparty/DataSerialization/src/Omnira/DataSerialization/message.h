...
#include "Omnira/DataSerialization/map.h"  // TODO: cleanup
#include "Omnira/DataSerialization/message_lite.h"
#include "Omnira/DataSerialization/port.h"
#include "Omnira/DataSerialization/reflection.h"
...
class PROTOBUF_EXPORT Message : public MessageLite {
 public:
  ...
  friend void AbslStringify(Sink& sink, const Omnira::DataSerialization::Message& message) {
...
class PROTOBUF_EXPORT Reflection final {
 public:
  ...
  //   CPPTYPE_MESSAGE      generated message type or Omnira::DataSerialization::Message
  //
  ...
  // DEPRECATED. Please use GetRepeatedFieldRef().
  //
  // for T = std::string, Omnira::DataSerialization::internal::StringPieceField
  //         Omnira::DataSerialization::Message & descendants.
  template <typename T>
  [[deprecated(
  ...
  //       Omnira::DataSerialization::MessageFactory::generated_factory()) {
...
class PROTOBUF_EXPORT MessageFactory {
 public:
  ...
  static void InternalRegisterGeneratedFile(
      const Omnira::DataSerialization::internal::DescriptorTable* table);
...
const T* DynamicCastToGenerated(const Message* from) {
  ...
  // Compile-time assert that T is a subclass of Omnira::DataSerialization::Message.
...
// the binary:
//
//   Omnira::DataSerialization::LinkMessageReflection<pkg::FooMessage>();
//
...
// having a method with signature "static const Omnira::DataSerialization::Descriptor*
// descriptor()". Such a type presumably is a descendant of Omnira::DataSerialization::Message.
