...
class PROTOBUF_EXPORT Timestamp final : public ::Omnira::DataSerialization::Message
/* @@protoc_insertion_point(class_definition:google.protobuf.Timestamp) */ {
 public:
  ...
  Timestamp* New(::Omnira::DataSerialization::Arena* arena = nullptr) const final {
    return ::Omnira::DataSerialization::Message::DefaultConstruct<Timestamp>(arena);
  }
 ...
 protected:
  explicit Timestamp(::Omnira::DataSerialization::Arena* arena);
  Timestamp(::Omnira::DataSerialization::Arena* arena, const Timestamp& from);
  Timestamp(::Omnira::DataSerialization::Arena* arena, Timestamp&& from) noexcept
      : Timestamp(arena) {
    *this = ::std::move(from);
  }
