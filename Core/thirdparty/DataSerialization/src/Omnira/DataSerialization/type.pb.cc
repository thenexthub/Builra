    ...
    ::_pbi::ConstantInitialized) noexcept
      : options_{},
        ...
        default_value_(
            &::Omnira::DataSerialization::internal::fixed_address_empty_string,
            ::_pbi::ConstantInitialized()),
        kind_{static_cast< ::Omnira::DataSerialization::Field_Kind >(0)},
        cardinality_{static_cast< ::Omnira::DataSerialization::Field_Cardinality >(0)},
        number_{0},
        oneof_index_{0},
        packed_{false},
        _cached_size_{0} {}
...
inline constexpr Type::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ...
        syntax_{static_cast< ::Omnira::DataSerialization::Syntax >(0)} {}
...
const ::uint32_t
    TableStruct_google_2fprotobuf_2ftype_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Type, _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Type, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Type, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Type, _impl_.fields_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Type, _impl_.oneofs_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Type, _impl_.options_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Type, _impl_.source_context_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Type, _impl_.syntax_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Type, _impl_.edition_),
        ~0u,
        ~0u,
        ~0u,
        ~0u,
        ...
        ~0u,
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.kind_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.cardinality_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.number_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.type_url_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.oneof_index_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.packed_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.options_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.json_name_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Field, _impl_.default_value_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Enum, _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Enum, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Enum, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Enum, _impl_.enumvalue_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Enum, _impl_.options_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Enum, _impl_.source_context_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Enum, _impl_.syntax_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Enum, _impl_.edition_),
        ~0u,
        ~0u,
        ~0u,
        0,
        ...
        ~0u,
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::EnumValue, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::EnumValue, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::EnumValue, _impl_.number_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::EnumValue, _impl_.options_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Option, _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Option, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Option, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::Omnira::DataSerialization::Option, _impl_.value_),
        ~0u,
        0,
};
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, 15, -1, sizeof(::Omnira::DataSerialization::Type)},
        {22, -1, -1, sizeof(::Omnira::DataSerialization::Field)},
        {40, 54, -1, sizeof(::Omnira::DataSerialization::Enum)},
        {60, -1, -1, sizeof(::Omnira::DataSerialization::EnumValue)},
        {71, 81, -1, sizeof(::Omnira::DataSerialization::Option)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::Omnira::DataSerialization::_Type_default_instance_._instance,
    &::Omnira::DataSerialization::_Field_default_instance_._instance,
    &::Omnira::DataSerialization::_Enum_default_instance_._instance,
    &::Omnira::DataSerialization::_EnumValue_default_instance_._instance,
    &::Omnira::DataSerialization::_Option_default_instance_._instance,
};
const char descriptor_table_protodef_google_2fprotobuf_2ftype_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\032Omnira/DataSerialization/type.proto\022\017google.pro"
    "tobuf\032\031Omnira/DataSerialization/any.proto\032$google"
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_google_2fprotobuf_2ftype_2eproto = {
    ...
    "Omnira/DataSerialization/type.proto",
...
namespace Omnira {
namespace DataSerialization {
const ::Omnira::DataSerialization::EnumDescriptor* Field_Kind_descriptor() {
  ::Omnira::DataSerialization::internal::AssignDescriptors(&descriptor_table_google_2fprotobuf_2ftype_2eproto);
...
constexpr int Field::Kind_ARRAYSIZE;
        ...
        // (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
const ::Omnira::DataSerialization::EnumDescriptor* Field_Cardinality_descriptor() {
  ::Omnira::DataSerialization::internal::AssignDescriptors(&descriptor_table_google_2fprotobuf_2ftype_2eproto);
...
#endif  // (__cplusplus < 201703) &&
        // (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
const ::Omnira::DataSerialization::EnumDescriptor* Syntax_descriptor() {
  ::Omnira::DataSerialization::internal::AssignDescriptors(&descriptor_table_google_2fprotobuf_2ftype_2eproto);
...
Type::Type(::Omnira::DataSerialization::Arena* arena)
...
inline PROTOBUF_NDEBUG_INLINE Type::Impl_::Impl_(
    ...
    const Impl_& from, const ::Omnira::DataSerialization::Type& from_msg)
...
Type::Type(
  ...
  _impl_.source_context_ = (cached_has_bits & 0x00000001u) ? ::Omnira::DataSerialization::Message::CopyConstruct<::Omnira::DataSerialization::SourceContext>(
...
const ::_pbi::TcParseTable<3, 7, 3, 46, 2> Type::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Type>(),  // to_prefetch
    ...
    {::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Field>()},
    {::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Option>()},
    {::_pbi::TcParser::GetTable<::Omnira::DataSerialization::SourceContext>()},
  }}, {{
    "\24\4\0\6\0\0\0\7"
...
::uint8_t* Type::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Type.name");
  ...
  for (int i = 0, n = this->_internal_oneofs_size(); i < n; ++i) {
    ...
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Type.oneofs");
  ...
  if (!this->_internal_edition().empty()) {
    ...
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Type.edition");
...
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.Type)
  ...
  // repeated string oneofs = 3;
  total_size += 1 * ::Omnira::DataSerialization::internal::FromIntSize(_internal_oneofs().size());
  ...
  if (cached_has_bits & 0x00000001u) {
    total_size +=
        1 + ::Omnira::DataSerialization::internal::WireFormatLite::MessageSize(*_impl_.source_context_);
  }
...
void Type::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    if (_this->_impl_.source_context_ == nullptr) {
      _this->_impl_.source_context_ =
          ::Omnira::DataSerialization::Message::CopyConstruct<::Omnira::DataSerialization::SourceContext>(arena, *from._impl_.source_context_);
    } else {
...
::Omnira::DataSerialization::Metadata Type::GetMetadata() const {
...
Field::Field(::Omnira::DataSerialization::Arena* arena)
    : ::Omnira::DataSerialization::Message(arena) {
  SharedCtor(arena);
...
inline PROTOBUF_NDEBUG_INLINE Field::Impl_::Impl_(
    ::Omnira::DataSerialization::internal::InternalVisibility visibility, ::Omnira::DataSerialization::Arena* arena,
    const Impl_& from, const ::Omnira::DataSerialization::Field& from_msg)
      : options_{visibility, arena, from.options_},
        name_(arena, from.name_),
...
const ::_pbi::TcParseTable<4, 10, 1, 72, 2> Field::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Field>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
...
::uint8_t* Field::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    const std::string& _s = this->_internal_name();
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Field.name");
  ...
  if (!this->_internal_type_url().empty()) {
    ...
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Field.type_url");
  ...
  if (!this->_internal_json_name().empty()) {
    ...
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Field.json_name");
  ...
  if (!this->_internal_default_value().empty()) {
    ...
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Field.default_value");
...
void Field::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
...
::Omnira::DataSerialization::Metadata Field::GetMetadata() const {
  return ::Omnira::DataSerialization::Message::GetMetadataImpl(GetClassData()->full());
}
// ===================================================================
...
Enum::Enum(::Omnira::DataSerialization::Arena* arena)
    : ::Omnira::DataSerialization::Message(arena) {
  SharedCtor(arena);
...
inline PROTOBUF_NDEBUG_INLINE Enum::Impl_::Impl_(
    ::Omnira::DataSerialization::internal::InternalVisibility visibility, ::Omnira::DataSerialization::Arena* arena,
    const Impl_& from, const ::Omnira::DataSerialization::Enum& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
const ::_pbi::TcParseTable<3, 6, 3, 40, 2> Enum::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Enum>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
    // string name = 1;
    ...
    {::_pbi::TcParser::GetTable<::Omnira::DataSerialization::EnumValue>()},
    {::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Option>()},
    {::_pbi::TcParser::GetTable<::Omnira::DataSerialization::SourceContext>()},
  }}, {{
    "\24\4\0\0\0\0\7\0"
...
::uint8_t* Enum::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    const std::string& _s = this->_internal_name();
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Enum.name");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
  ...
  if (!this->_internal_edition().empty()) {
    const std::string& _s = this->_internal_edition();
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Enum.edition");
    target = stream->WriteStringMaybeAliased(6, _s, target);
  }
...
void Enum::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
...
::Omnira::DataSerialization::Metadata Enum::GetMetadata() const {
  return ::Omnira::DataSerialization::Message::GetMetadataImpl(GetClassData()->full());
}
// ===================================================================
...
EnumValue::EnumValue(::Omnira::DataSerialization::Arena* arena)
    : ::Omnira::DataSerialization::Message(arena) {
  SharedCtor(arena);
...
inline PROTOBUF_NDEBUG_INLINE EnumValue::Impl_::Impl_(
    ::Omnira::DataSerialization::internal::InternalVisibility visibility, ::Omnira::DataSerialization::Arena* arena,
    const Impl_& from, const ::Omnira::DataSerialization::EnumValue& from_msg)
      : options_{visibility, arena, from.options_},
        name_(arena, from.name_),
        _cached_size_{0} {}
...
const ::_pbi::TcParseTable<2, 3, 1, 38, 2> EnumValue::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::EnumValue>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
    // string name = 1;
...
::uint8_t* EnumValue::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    const std::string& _s = this->_internal_name();
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.EnumValue.name");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
...
void EnumValue::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
...
::Omnira::DataSerialization::Metadata EnumValue::GetMetadata() const {
  return ::Omnira::DataSerialization::Message::GetMetadataImpl(GetClassData()->full());
}
// ===================================================================
...
Option::Option(::Omnira::DataSerialization::Arena* arena)
    : ::Omnira::DataSerialization::Message(arena) {
  SharedCtor(arena);
...
inline PROTOBUF_NDEBUG_INLINE Option::Impl_::Impl_(
    ::Omnira::DataSerialization::internal::InternalVisibility visibility, ::Omnira::DataSerialization::Arena* arena,
    const Impl_& from, const ::Omnira::DataSerialization::Option& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        name_(arena, from.name_) {}
...
Option::Option(
  ...
  new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
  ::uint32_t cached_has_bits = _impl_._has_bits_[0];
  _impl_.value_ = (cached_has_bits & 0x00000001u) ? ::Omnira::DataSerialization::Message::CopyConstruct<::Omnira::DataSerialization::Any>(
...
const ::_pbi::TcParseTable<1, 2, 1, 35, 2> Option::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::Omnira::DataSerialization::Option>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
::uint8_t* Option::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    const std::string& _s = this->_internal_name();
    ::Omnira::DataSerialization::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::Omnira::DataSerialization::internal::WireFormatLite::SERIALIZE, "google.protobuf.Option.name");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.Option)
  ...
  if (cached_has_bits & 0x00000001u) {
    total_size +=
        1 + ::Omnira::DataSerialization::internal::WireFormatLite::MessageSize(*_impl_.value_);
  }
...
void Option::MergeImpl(::Omnira::DataSerialization::MessageLite& to_msg, const ::Omnira::DataSerialization::MessageLite& from_msg) {
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    if (_this->_impl_.value_ == nullptr) {
      _this->_impl_.value_ =
          ::Omnira::DataSerialization::Message::CopyConstruct<::Omnira::DataSerialization::Any>(arena, *from._impl_.value_);
    } else {
...
::Omnira::DataSerialization::Metadata Option::GetMetadata() const {
  return ::Omnira::DataSerialization::Message::GetMetadataImpl(GetClassData()->full());
}
