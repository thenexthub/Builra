...
#include "Omnira/DataSerialization/map_test_util.h"
...
TEST(GeneratedMessageReflectionTest, GetStringViewWithExtensions) {
  ...
  Omnira::DataSerialization::FileDescriptor const* descriptor_file =
      message.GetDescriptor()->file();
  Omnira::DataSerialization::FieldDescriptor const* string_ext =
      descriptor_file->FindExtensionByName("optional_string_extension");
  Omnira::DataSerialization::FieldDescriptor const* string_piece_ext =
      descriptor_file->FindExtensionByName("optional_string_piece_extension");
  Omnira::DataSerialization::FieldDescriptor const* cord_ext =
...
TEST(GeneratedMessageReflectionTest, UsageErrors) {
  ...
  EXPECT_DEATH(
      ...
      "  Method      : Omnira::DataSerialization::Reflection::GetInt32\n"
  ...
  EXPECT_DEATH(
      reflection->HasField(
          ...
          unittest::ForeignMessage::descriptor()->FindFieldByName("c")),
      "Protocol Buffer reflection usage error:\n"
      "  Method      : Omnira::DataSerialization::Reflection::HasField\n"
      "  Message type: protobuf_unittest.TestAllTypes\n"
      "  Field       : protobuf_unittest.ForeignMessage.c\n"
      "  Problem     : Field does not match message type.");
}
