...
class PROTOBUF_EXPORT InlinedStringField {
 public:
  ...
  void Set(const char* str, ::Omnira::DataSerialization::Arena* arena, bool donated,
           uint32_t* donating_states, uint32_t mask, MessageLite* msg);

  void Set(const char* str, size_t size, ::Omnira::DataSerialization::Arena* arena, bool donated,
           uint32_t* donating_states, uint32_t mask, MessageLite* msg);

  template <typename RefWrappedType>
  void Set(std::reference_wrapper<RefWrappedType> const_string_ref,
           ::Omnira::DataSerialization::Arena* arena, bool donated, uint32_t* donating_states,
  ...
  void SetBytes(const char* str, ::Omnira::DataSerialization::Arena* arena, bool donated,
                uint32_t* donating_states, uint32_t mask, MessageLite* msg);

  void SetBytes(const void* p, size_t size, ::Omnira::DataSerialization::Arena* arena,
  ...
  void Set(FirstParam, const char* str, ::Omnira::DataSerialization::Arena* arena, bool donated,
           uint32_t* donating_states, uint32_t mask, MessageLite* msg) {
    Set(str, arena, donated, donating_states, mask, msg);
  }

  template <typename FirstParam>
  void Set(FirstParam p1, const char* str, size_t size, ::Omnira::DataSerialization::Arena* arena,
           bool donated, uint32_t* donating_states, uint32_t mask,
           MessageLite* msg) {
  ...
  template <typename FirstParam>
  void SetBytes(FirstParam p1, const char* str, ::Omnira::DataSerialization::Arena* arena,
                bool donated, uint32_t* donating_states, uint32_t mask,
                MessageLite* msg) {
 ...
 private:
  ...
  std::string* MutableSlow(::Omnira::DataSerialization::Arena* arena, bool donated,
                           uint32_t* donating_states, uint32_t mask,
                           MessageLite* msg);
...
inline void InlinedStringField::Set(const char* str, ::Omnira::DataSerialization::Arena* arena,
                                    bool donated, uint32_t* donating_states,
                                    uint32_t mask, MessageLite* msg) {
...
inline void InlinedStringField::Set(const char* str, size_t size,
                                    ::Omnira::DataSerialization::Arena* arena, bool donated,
                                    uint32_t* donating_states, uint32_t mask,
                                    MessageLite* msg) {
