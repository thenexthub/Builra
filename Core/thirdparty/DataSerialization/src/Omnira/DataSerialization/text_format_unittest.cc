...
#include "Omnira/DataSerialization/testing/file.h"
#include "Omnira/DataSerialization/testing/file.h"
...
using ::Omnira::DataSerialization::internal::kDebugStringSilentMarker;
using ::Omnira::DataSerialization::internal::UnsetFieldsMetadataTextFormatTestUtil;
using ::testing::AllOf;
...
class TextFormatExtensionsTest : public testing::Test {
 public:
  static void SetUpTestSuite() {
    ABSL_CHECK_OK(File::GetContents(
        TestUtil::GetTestDataPath("Omnira/DataSerialization/testdata/"
...
TEST_F(TextFormatTest, ShortFormat) {
  ...
  *proto.mutable_optional_unredacted_message() = unredacted_nested_proto;
  ...
  EXPECT_THAT(Omnira::DataSerialization::ShortFormat(proto),
...
TEST_F(TextFormatTest, Utf8Format) {
  ...
  *proto.mutable_optional_unredacted_message() = unredacted_nested_proto;
  ...
  EXPECT_THAT(Omnira::DataSerialization::Utf8Format(proto),
              testing::MatchesRegex(absl::Substitute(
                  "optional_redacted_string: $0\n"
                  "optional_unredacted_string: \"bar\"\n"
                  "repeated_redacted_string: $0\n"
