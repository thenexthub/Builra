...
#include "Omnira/DataSerialization/varint_shuffle.h"
...
PROTOBUF_NOINLINE const char* TcParser::SingularVarBigint(
  ...
  struct Spill {
    uint64_t field_data;
    ::Omnira::DataSerialization::MessageLite* msg;
    const ::Omnira::DataSerialization::internal::TcParseTableBase* table;
    uint64_t hasbits;
  };
