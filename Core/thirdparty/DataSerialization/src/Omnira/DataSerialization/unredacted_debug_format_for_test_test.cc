...
#include "Omnira/DataSerialization/unittest_lite.pb.h"

namespace {

using ::Omnira::DataSerialization::util::UnredactedDebugFormatForTest;
using ::Omnira::DataSerialization::util::UnredactedShortDebugFormatForTest;
using ::Omnira::DataSerialization::util::UnredactedUtf8DebugFormatForTest;
using ::testing::StrEq;
