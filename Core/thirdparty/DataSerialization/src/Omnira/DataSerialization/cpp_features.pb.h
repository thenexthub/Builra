...
// source: Omnira/DataSerialization/cpp_features.proto
...
inline const std::string& CppFeatures_StringType_Name(CppFeatures_StringType value) {
  return ::Omnira::DataSerialization::internal::NameOfDenseEnum<CppFeatures_StringType_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
inline bool CppFeatures_StringType_Parse(absl::string_view name, CppFeatures_StringType* value) {
  return ::Omnira::DataSerialization::internal::ParseNamedEnum<CppFeatures_StringType>(
...
class PROTOBUF_EXPORT CppFeatures final : public ::Omnira::DataSerialization::Message
/* @@protoc_insertion_point(class_definition:pb.CppFeatures) */ {
 public:
  ...
  CppFeatures* New(::Omnira::DataSerialization::Arena* arena = nullptr) const final {
    return ::Omnira::DataSerialization::Message::DefaultConstruct<CppFeatures>(arena);
  }
 ...
 protected:
  explicit CppFeatures(::Omnira::DataSerialization::Arena* arena);
  CppFeatures(::Omnira::DataSerialization::Arena* arena, const CppFeatures& from);
  CppFeatures(::Omnira::DataSerialization::Arena* arena, CppFeatures&& from) noexcept
      : CppFeatures(arena) {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  static inline const ::Omnira::DataSerialization::EnumDescriptor* StringType_descriptor() {
...
PROTOBUF_EXPORT extern ::Omnira::DataSerialization::internal::ExtensionIdentifier<
    ::Omnira::DataSerialization::FeatureSet, ::Omnira::DataSerialization::internal::MessageTypeTraits< ::pb::CppFeatures >, 11,
    false>
    cpp;
