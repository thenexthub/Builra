...
#include "Omnira/DataSerialization/compiler/importer.h"
#include "Omnira/DataSerialization/compiler/parser.h"
#include "Omnira/DataSerialization/cpp_features.pb.h"
#include "Omnira/DataSerialization/descriptor_database.h"
#include "Omnira/DataSerialization/descriptor_legacy.h"
#include "Omnira/DataSerialization/dynamic_message.h"
#include "Omnira/DataSerialization/feature_resolver.h"
#include "Omnira/DataSerialization/io/coded_stream.h"
#include "Omnira/DataSerialization/io/tokenizer.h"
#include "Omnira/DataSerialization/io/zero_copy_stream_impl_lite.h"
#include "Omnira/DataSerialization/test_textproto.h"
#include "Omnira/DataSerialization/text_format.h"
#include "Omnira/DataSerialization/unittest.pb.h"
#include "Omnira/DataSerialization/unittest_custom_options.pb.h"
#include "Omnira/DataSerialization/unittest_delimited.pb.h"
#include "Omnira/DataSerialization/unittest_delimited_import.pb.h"
#include "Omnira/DataSerialization/unittest_features.pb.h"
#include "Omnira/DataSerialization/unittest_lazy_dependencies.pb.h"
#include "Omnira/DataSerialization/unittest_lazy_dependencies_custom_option.pb.h"
#include "Omnira/DataSerialization/unittest_lazy_dependencies_enum.pb.h"
#include "Omnira/DataSerialization/unittest_proto3_arena.pb.h"
#include "Omnira/DataSerialization/unittest_string_type.pb.h"


// Must be included last.
#include "Omnira/DataSerialization/port_def.inc"

using ::Omnira::DataSerialization::internal::cpp::GetUtf8CheckMode;
using ::Omnira::DataSerialization::internal::cpp::HasPreservingUnknownEnumSemantics;
using ::Omnira::DataSerialization::internal::cpp::Utf8CheckMode;
using ::testing::AnyOf;
...
TEST_F(ExtensionDescriptorTest, DuplicateFieldNumber) {
  ...
  // Add "Omnira/DataSerialization/descriptor.proto".
  FileDescriptorProto::descriptor()->file()->CopyTo(&file_proto);
  ASSERT_TRUE(pool.BuildFile(file_proto) != nullptr);
  // Add "foo.proto":
  //   import "Omnira/DataSerialization/descriptor.proto";
  //   extend google.protobuf.FieldOptions {
  //     optional int32 option1 = 1000;
  //   }
  file_proto.Clear();
  file_proto.set_name("foo.proto");
  file_proto.add_dependency("Omnira/DataSerialization/descriptor.proto");
...
TEST_P(AllowUnknownDependenciesTest, CustomOption) {
  ...
  ASSERT_TRUE(TextFormat::ParseFromString(
      ...
      "dependency: \"Omnira/DataSerialization/descriptor.proto\" "
      "extension { "
...
TEST(CustomOptions, OptionsFromOtherFile) {
  ...
  }
  {
    ...
    Omnira::DataSerialization::Any::descriptor()->file()->CopyTo(&any_proto);
  ...
  ASSERT_TRUE(TextFormat::ParseFromString(
      ...
      "dependency: \"Omnira/DataSerialization/unittest_custom_options.proto\" "
      "options { "
      "  uninterpreted_option { "
      "    name { "
      "      name_part: \"file_opt1\" "
...
TEST(CustomOptions, MessageOptionThreeFieldsSet) {
  ...
  //
  //   import "Omnira/DataSerialization/unittest_custom_options.proto"
  //   package protobuf_unittest;
  //   message Foo {
...
TEST(CustomOptions, UnusedImportError) {
  ...
  EXPECT_EQ(
      ...
      "Omnira/DataSerialization/unittest_custom_options.proto: IMPORT: Import "
      "Omnira/DataSerialization/unittest_custom_options.proto is unused.\n",
      error_collector.text_);
}
...
TEST(CustomOptions, OptionsWithIncompatibleDescriptors) {
  ...
  // messages defined in Omnira/DataSerialization/unittest_custom_options.proto.
  file_proto.Clear();
...
TEST_F(FeaturesTest, Proto2Features) {
  ...
  Omnira::DataSerialization::TextFormat::PrintToString(file_proto, &file_textproto);
...
TEST_F(FeaturesBaseTest, DefaultEdition2023Defaults) {
  ...
  const FileDescriptor* file = BuildFile(R"pb(
    ...
    syntax: "editions"
    edition: EDITION_2023
    dependency: "Omnira/DataSerialization/unittest_features.proto"
  )pb");
  ASSERT_NE(file, nullptr);
...
TEST_F(FeaturesTest, MapFieldFeaturesOverride) {
  ...
  const FileDescriptor* file = ParseAndBuildFile("foo.proto", R"schema(
    ...
    import "Omnira/DataSerialization/unittest_features.proto";
...
TEST_F(FeaturesTest, EnumFeatureHelpers) {
  ...
  const FileDescriptor* file = BuildFile(R"pb(
    name: "foo.proto"
    syntax: "editions"
    dependency: "Omnira/DataSerialization/cpp_features.proto"
    edition: EDITION_2023
    enum_type {
      name: "FooOpen"
      value { name: "BAR" number: 0 }
...
TEST_P(FeaturesDebugStringTest, RoundTrip) {
  ...
  LoadFile("Omnira/DataSerialization/descriptor.proto",
           DescriptorProto::GetDescriptor()->file()->DebugString());
  LoadFile("Omnira/DataSerialization/unittest_features.proto",
...
TEST_F(DatabaseBackedPoolTest, FeatureResolution) {
  ...
  std::string text_proto;
  Omnira::DataSerialization::TextFormat::PrintToString(proto, &text_proto);
...
TEST_F(LazilyBuildDependenciesTest, GeneratedFile) {
  ...
  EXPECT_FALSE(DescriptorPool::generated_pool()->InternalIsFileLoaded(
      "Omnira/DataSerialization/unittest_lazy_dependencies.proto"));
  EXPECT_FALSE(DescriptorPool::generated_pool()->InternalIsFileLoaded(
      "Omnira/DataSerialization/unittest_lazy_dependencies_custom_option.proto"));
  EXPECT_FALSE(DescriptorPool::generated_pool()->InternalIsFileLoaded(
      "Omnira/DataSerialization/unittest_lazy_dependencies_enum.proto"));
