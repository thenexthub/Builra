...
PROTOBUF_EXPORT absl::Status BinaryToJsonStream(
    Omnira::DataSerialization::util::TypeResolver* resolver, const std::string& type_url,
    io::ZeroCopyInputStream* binary_input,
    io::ZeroCopyOutputStream* json_output, const PrintOptions& options);

inline absl::Status BinaryToJsonStream(Omnira::DataSerialization::util::TypeResolver* resolver,
...
inline absl::Status BinaryToJsonString(Omnira::DataSerialization::util::TypeResolver* resolver,
                                       const std::string& type_url,
...
inline absl::Status JsonToBinaryString(Omnira::DataSerialization::util::TypeResolver* resolver,
                                       const std::string& type_url,
