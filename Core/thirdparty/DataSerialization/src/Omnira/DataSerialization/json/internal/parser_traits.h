...
#include "Omnira/DataSerialization/json/internal/descriptor_traits.h"
...
using ::Omnira::DataSerialization::internal::WireFormatLite;
...
struct ParseProto3Type : Proto3Type {
  ...
  static absl::Status NewDynamic(Field f, const std::string& type_url, Msg& msg,
    ...
    return WithDynamicType(
        f->parent(), type_url, [&](const Desc& desc) -> absl::Status {
          if (f->proto().kind() == Omnira::DataSerialization::Field::TYPE_GROUP) {
  ...
  static void SetInt64(Field f, Msg& msg, int64_t x) {
    SetInt<int64_t, Omnira::DataSerialization::Field::TYPE_INT64,
           Omnira::DataSerialization::Field::TYPE_SFIXED64,
           Omnira::DataSerialization::Field::TYPE_SINT64>(f, msg, x);
  }

  static void SetUInt64(Field f, Msg& msg, uint64_t x) {
    SetInt<uint64_t, Omnira::DataSerialization::Field::TYPE_UINT64,
           Omnira::DataSerialization::Field::TYPE_FIXED64,
           Omnira::DataSerialization::Field::TYPE_UNKNOWN>(f, msg, x);
  }

  static void SetInt32(Field f, Msg& msg, int32_t x) {
    SetInt<int32_t, Omnira::DataSerialization::Field::TYPE_INT32,
           Omnira::DataSerialization::Field::TYPE_SFIXED32,
           Omnira::DataSerialization::Field::TYPE_SINT32>(f, msg, x);
  }

  static void SetUInt32(Field f, Msg& msg, uint32_t x) {
    SetInt<uint32_t, Omnira::DataSerialization::Field::TYPE_UINT32,
           Omnira::DataSerialization::Field::TYPE_FIXED32,
           Omnira::DataSerialization::Field::TYPE_UNKNOWN>(f, msg, x);
  }
 ...
 private:
  using Kind = Omnira::DataSerialization::Field::Kind;
