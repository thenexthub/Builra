...
#include "Omnira/DataSerialization/unittest_proto3_optional.pb.h"
...
TEST(Proto3OptionalTest, OptionalFieldReflection) {
  ...
  protobuf_unittest::TestProto3Optional msg;
  const Omnira::DataSerialization::Descriptor* d = msg.GetDescriptor();
  const Omnira::DataSerialization::Reflection* r = msg.GetReflection();
  const Omnira::DataSerialization::FieldDescriptor* f = d->FindFieldByName("optional_int32");
  const Omnira::DataSerialization::OneofDescriptor* o = d->FindOneofByName("_optional_int32");
  ABSL_CHECK(f);
  ABSL_CHECK(o);
...
TEST(Proto3OptionalTest, ClearNonOptionalMessageField) {
  ...
  const Omnira::DataSerialization::Descriptor* d = msg.GetDescriptor();
  const Omnira::DataSerialization::Reflection* r = msg.GetReflection();
  const Omnira::DataSerialization::FieldDescriptor* f = d->FindFieldByName("nested_message");
  r->ClearField(&msg, f);
}
...
TEST(Proto3OptionalTest, ClearOptionalMessageField) {
  ...
  const Omnira::DataSerialization::Descriptor* d = msg.GetDescriptor();
  const Omnira::DataSerialization::Reflection* r = msg.GetReflection();
  const Omnira::DataSerialization::FieldDescriptor* f =
      d->FindFieldByName("optional_nested_message");
  r->ClearField(&msg, f);
}
...
TEST(Proto3OptionalTest, SwapNonOptionalMessageField) {
  ...
  const Omnira::DataSerialization::Descriptor* d = msg1.GetDescriptor();
  const Omnira::DataSerialization::Reflection* r = msg1.GetReflection();
  const Omnira::DataSerialization::FieldDescriptor* f = d->FindFieldByName("nested_message");
