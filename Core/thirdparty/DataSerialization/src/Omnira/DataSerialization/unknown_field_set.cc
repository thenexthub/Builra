...
bool UnknownFieldSet::SerializeToString(std::string* output) const {
  const size_t size =
      Omnira::DataSerialization::internal::WireFormat::ComputeUnknownFieldsSize(*this);
  absl::strings_internal::STLStringResizeUninitializedAmortized(output, size);
  Omnira::DataSerialization::internal::WireFormat::SerializeUnknownFieldsToArray(
...
bool UnknownFieldSet::SerializeToCodedStream(
  ...
  Omnira::DataSerialization::internal::WireFormat::SerializeUnknownFields(*this, output);
