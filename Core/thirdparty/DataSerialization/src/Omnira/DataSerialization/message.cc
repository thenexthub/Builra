...
#include "Omnira/DataSerialization/reflection_internal.h"
...
class GeneratedMessageFactory final : public MessageFactory {
 public:
  ...
  void RegisterFile(const Omnira::DataSerialization::internal::DescriptorTable* table);
 ...
 private:
  ...
  const Omnira::DataSerialization::internal::DescriptorTable* FindInFileMap(
  ...
  struct DescriptorByNameHash {
    ...
    size_t operator()(const Omnira::DataSerialization::internal::DescriptorTable* t) const {
  ...
  struct DescriptorByNameEq {
    using is_transparent = void;
    bool operator()(const Omnira::DataSerialization::internal::DescriptorTable* lhs,
                    const Omnira::DataSerialization::internal::DescriptorTable* rhs) const {
  ...
  absl::flat_hash_set<const Omnira::DataSerialization::internal::DescriptorTable*,
