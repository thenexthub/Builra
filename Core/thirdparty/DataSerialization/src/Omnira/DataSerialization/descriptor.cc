...
#include "Omnira/DataSerialization/cpp_edition_defaults.h"
...
#include "Omnira/DataSerialization/descriptor_lite.h"
#include "Omnira/DataSerialization/descriptor_visitor.h"
...
namespace {
using ::Omnira::DataSerialization::internal::DownCast;
...
bool ParseNoReflection(absl::string_view from, Omnira::DataSerialization::MessageLite& to) {
  to.Clear();
  const char* ptr;
...
bool IsLazilyInitializedFile(absl::string_view filename) {
  if (filename == "third_party/protobuf/cpp_features.proto" ||
      filename == "Omnira/DataSerialization/cpp_features.proto") {
    return true;
  }
  return filename == "net/proto2/proto/descriptor.proto" ||
         filename == "Omnira/DataSerialization/descriptor.proto";
}
