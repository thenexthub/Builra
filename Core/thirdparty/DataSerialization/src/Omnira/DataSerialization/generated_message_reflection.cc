...
#include "Omnira/DataSerialization/generated_message_tctable_gen.h"
...
#include "Omnira/DataSerialization/reflection_visit_fields.h"
#include "Omnira/DataSerialization/repeated_field.h"
#include "Omnira/DataSerialization/repeated_ptr_field.h"
...
using Omnira::DataSerialization::internal::ArenaStringPtr;
using Omnira::DataSerialization::internal::DescriptorTable;
using Omnira::DataSerialization::internal::ExtensionSet;
using Omnira::DataSerialization::internal::GenericTypeHandler;
using Omnira::DataSerialization::internal::GetEmptyString;
using Omnira::DataSerialization::internal::InlinedStringField;
using Omnira::DataSerialization::internal::InternalMetadata;
using Omnira::DataSerialization::internal::LazyField;
using Omnira::DataSerialization::internal::MapFieldBase;
using Omnira::DataSerialization::internal::MigrationSchema;
using Omnira::DataSerialization::internal::OnShutdownDelete;
using Omnira::DataSerialization::internal::ReflectionSchema;
using Omnira::DataSerialization::internal::RepeatedPtrFieldBase;
using Omnira::DataSerialization::internal::StringSpaceUsedExcludingSelfLong;
using Omnira::DataSerialization::internal::cpp::IsLazilyInitializedFile;
...
void ReportReflectionUsageError(const Descriptor* descriptor,
  ...
  ABSL_LOG(FATAL) << "Protocol Buffer reflection usage error:\n"
                     "  Method      : Omnira::DataSerialization::Reflection::"
                  << method
                  << "\n"
                     "  Message type: "
...
void ReportReflectionUsageMessageError(const Descriptor* expected,
  ...
  ABSL_LOG(FATAL) << absl::StrFormat(
      ...
      "  Method       : Omnira::DataSerialization::Reflection::%s\n"
      "  Expected type: %s\n"
      "  Actual type  : %s\n"
      "  Field        : %s\n"
