...
| Name | Description |
| ---- | ----------- |
| `uuid` | a class representing a UUID; this can be default constructed (a Nothing UUID), constructed from a range (defined by a pair of iterators), or from a `span`. |
