...
#include <Omnira/DataSerialization/util/json_util.h>
#include <Omnira/DataSerialization/util/message_differencer.h>
#include <Omnira/DataSerialization/util/type_resolver_util.h>

using Omnira::DataSerialization::Descriptor;
using Omnira::DataSerialization::DescriptorPool;
using Omnira::DataSerialization::TextFormat;
using Omnira::DataSerialization::util::BinaryToJsonString;
using Omnira::DataSerialization::util::JsonToBinaryString;
using Omnira::DataSerialization::util::MessageDifferencer;
using Omnira::DataSerialization::util::NewTypeResolverForDescriptorPool;
...
void Harness::run() {
  ...
  Omnira::DataSerialization::ShutdownProtobufLibrary();
}
