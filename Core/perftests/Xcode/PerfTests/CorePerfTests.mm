...
#import "builra/Basic/ExecutionQueue.h"
#import "builra/Core/BuildEngine.h"
...
- (void)testBuildEngineBasicPerf {
  ...
  [self measureBlock:^{
      builra::commands::executeBuildEngineCommand({
          "ack", "3", "14" });
    }];
}
...
- (void)testBuildEngineDependencyScanningOnLinearChain {
  ...
  struct LinearDelegate : public BuildEngineDelegate, public basic::ExecutionQueueDelegate {
    ...
    void processStarted(basic::ProcessContext*, basic::ProcessHandle, builra_pid_t) override { }
