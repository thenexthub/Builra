...
#include "toolchain/Support/ARMBuildAttributes.h"
#include "toolchain/Support/TargetParser.h"
...
#include "toolchain/Support/ARMTargetParser.def"
};
...
ArchNames<AArch64::ArchKind> AArch64ARCHNames[] = {
 ...
 #include "toolchain/Support/AArch64TargetParser.def"
 };
...
unsigned toolchain::ARM::getDefaultFPU(StringRef CPU, ArchKind AK) {
  if (CPU == "generic")
...
unsigned toolchain::ARM::getDefaultExtensions(StringRef CPU, ArchKind AK) {
  if (CPU == "generic")
...
bool toolchain::ARM::getHWDivFeatures(unsigned HWDivKind,
...
bool toolchain::ARM::getExtensionFeatures(unsigned Extensions,
                                     std::vector<StringRef> &Features) {
...
bool toolchain::ARM::getFPUFeatures(unsigned FPUKind,
                               std::vector<StringRef> &Features) {
...
StringRef toolchain::ARM::getArchName(ArchKind AK) {
  return ARCHNames[static_cast<unsigned>(AK)].getName();
}

StringRef toolchain::ARM::getCPUAttr(ArchKind AK) {
  return ARCHNames[static_cast<unsigned>(AK)].getCPUAttr();
}

StringRef toolchain::ARM::getSubArch(ArchKind AK) {
  return ARCHNames[static_cast<unsigned>(AK)].getSubArch();
}

unsigned toolchain::ARM::getArchAttr(ArchKind AK) {
  return ARCHNames[static_cast<unsigned>(AK)].ArchAttr;
}

StringRef toolchain::ARM::getArchExtName(unsigned ArchExtKind) {
...
StringRef toolchain::ARM::getArchExtFeature(StringRef ArchExt) {
...
StringRef toolchain::ARM::getHWDivName(unsigned HWDivKind) {
...
StringRef toolchain::ARM::getDefaultCPU(StringRef Arch) {
...
StringRef toolchain::AArch64::getFPUName(unsigned FPUKind) {
...
unsigned toolchain::AArch64::getDefaultFPU(StringRef CPU, ArchKind AK) {
  if (CPU == "generic")
...
unsigned toolchain::AArch64::getDefaultExtensions(StringRef CPU, ArchKind AK) {
  if (CPU == "generic")
...
AArch64::ArchKind toolchain::AArch64::getCPUArchKind(StringRef CPU) {
  if (CPU == "generic")
...
bool toolchain::AArch64::getExtensionFeatures(unsigned Extensions,
                                     std::vector<StringRef> &Features) {
...
bool toolchain::AArch64::getFPUFeatures(unsigned FPUKind,
                               std::vector<StringRef> &Features) {
  return ARM::getFPUFeatures(FPUKind, Features);
}

bool toolchain::AArch64::getArchFeatures(AArch64::ArchKind AK,
                                    std::vector<StringRef> &Features) {
...
StringRef toolchain::AArch64::getArchName(ArchKind AK) {
  return AArch64ARCHNames[static_cast<unsigned>(AK)].getName();
}

StringRef toolchain::AArch64::getCPUAttr(ArchKind AK) {
  return AArch64ARCHNames[static_cast<unsigned>(AK)].getCPUAttr();
}

StringRef toolchain::AArch64::getSubArch(ArchKind AK) {
  return AArch64ARCHNames[static_cast<unsigned>(AK)].getSubArch();
}

unsigned toolchain::AArch64::getArchAttr(ArchKind AK) {
  return AArch64ARCHNames[static_cast<unsigned>(AK)].ArchAttr;
}

StringRef toolchain::AArch64::getArchExtName(unsigned ArchExtKind) {
...
StringRef toolchain::AArch64::getArchExtFeature(StringRef ArchExt) {
  if (ArchExt.startswith("no")) {
    StringRef ArchExtBase(ArchExt.substr(2));
    for (const auto &AE : AArch64ARCHExtNames) {
      if (AE.NegFeature && ArchExtBase == AE.getName())
...
StringRef toolchain::AArch64::getDefaultCPU(StringRef Arch) {
...
unsigned toolchain::AArch64::checkArchVersion(StringRef Arch) {
...
StringRef toolchain::ARM::getCanonicalArchName(StringRef Arch) {
...
unsigned toolchain::ARM::parseHWDiv(StringRef HWDiv) {
...
unsigned toolchain::ARM::parseFPU(StringRef FPU) {
...
unsigned toolchain::ARM::parseArchExt(StringRef ArchExt) {
...
ARM::ArchKind toolchain::ARM::parseCPUArch(StringRef CPU) {
...
void toolchain::ARM::fillValidCPUArchList(SmallVectorImpl<StringRef> &Values) {
...
void toolchain::AArch64::fillValidCPUArchList(SmallVectorImpl<StringRef> &Values) {
...
unsigned toolchain::ARM::parseArchVersion(StringRef Arch) {
  Arch = getCanonicalArchName(Arch);
  switch (parseArch(Arch)) {
  case ARM::ArchKind::ARMV2:
  case ARM::ArchKind::ARMV2A:
...
StringRef toolchain::ARM::computeDefaultTargetABI(const Triple &TT, StringRef CPU) {
  StringRef ArchName =
  ...
  if (TT.isOSBinFormatMachO()) {
    if (TT.getEnvironment() == Triple::EABI ||
        ...
        toolchain::ARM::parseArchProfile(ArchName) == ARM::ProfileKind::M)
      return "aapcs";
    if (TT.isWatchABI())
      return "aapcs16";
    return "apcs-gnu";
...
StringRef toolchain::AArch64::getCanonicalArchName(StringRef Arch) {
  return ARM::getCanonicalArchName(Arch);
}

unsigned toolchain::AArch64::parseFPU(StringRef FPU) {
...
AArch64::ArchExtKind toolchain::AArch64::parseArchExt(StringRef ArchExt) {
...
AArch64::ArchKind toolchain::AArch64::parseCPUArch(StringRef CPU) {
...
unsigned toolchain::AArch64::parseArchVersion(StringRef Arch) {
  return ARM::parseArchVersion(Arch);
}

bool toolchain::AArch64::isX18ReservedByDefault(const Triple &TT) {
