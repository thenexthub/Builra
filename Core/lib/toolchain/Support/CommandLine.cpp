...
public:
  void print() {
    ...
    OS << PACKAGE_VENDOR << " ";
#else
    OS << "TOOLCHAIN (http://toolchain.org/):\n  ";
#endif
    OS << PACKAGE_NAME << " version " << PACKAGE_VERSION;
#ifdef TOOLCHAIN_VERSION_INFO
    OS << " " << TOOLCHAIN_VERSION_INFO;
#endif
    OS << "\n  ";
#ifndef __OPTIMIZE__
    OS << "DEBUG build";
    ...
    OS << " with assertions";
#endif
#if TOOLCHAIN_VERSION_PRINTER_SHOW_HOST_TARGET_INFO
...
// Define the --version option that prints out the TOOLCHAIN version for the tool
