...
// Even though TOOLCHAIN might be built with NDEBUG, define symbols that the code
...
//
// BUILRA-ONLY: Debug.h macros are disabled for builra (they inject static
// constructors into library code).
#if !defined(NDEBUG) && defined(TOOLCHAIN_CODE_DISABLED_FOR_BUILRA)
