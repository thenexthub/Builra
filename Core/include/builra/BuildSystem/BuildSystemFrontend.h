...
#ifndef BUILRA_BUILDSYSTEM_BUILDSYSTEMFRONTEND_H
#define BUILRA_BUILDSYSTEM_BUILDSYSTEMFRONTEND_H
...
public:
  ...
  toolchain::SourceMgr& getSourceMgr();
...
public:
  ...
  std::string buildFilePath = "build.builra";
...
public:
  ...
  void parse(ArrayRef<std::string> args, toolchain::SourceMgr& sourceMgr);
