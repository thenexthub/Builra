...
#ifndef BUILRA_BUILDSYSTEM_COMMAND_H
#define BUILRA_BUILDSYSTEM_COMMAND_H
...
class Command : public basic::JobDescriptor {
  // DO NOT COPY
  Command(const Command&) BUILRA_DELETED_FUNCTION;
  void operator=(const Command&) BUILRA_DELETED_FUNCTION;
  Command &operator=(Command&& rhs) BUILRA_DELETED_FUNCTION;
...
public:
  ...
  // and provide some kind of dynamic dispatching mechanism (toolchain::cast<>, for
