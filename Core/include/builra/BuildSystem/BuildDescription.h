...
#ifndef BUILRA_BUILDSYSTEM_BUILDDESCRIPTION_H
#define BUILRA_BUILDSYSTEM_BUILDDESCRIPTION_H
...
class Node {
  // DO NOT COPY
  Node(const Node&) BUILRA_DELETED_FUNCTION;
  void operator=(const Node&) BUILRA_DELETED_FUNCTION;
  Node &operator=(Node&& rhs) BUILRA_DELETED_FUNCTION;
...
public:
  ...
  typedef toolchain::StringMap<std::unique_ptr<Node>> node_set;
  
  // FIXME: This is an inefficent map, the string is duplicated.
  typedef toolchain::StringMap<std::unique_ptr<Target>> target_set;

  // FIXME: This is an inefficent map, the string is duplicated.
  typedef toolchain::StringMap<std::unique_ptr<Command>> command_set;
  
  // FIXME: This is an inefficent map, the string is duplicated.
  typedef toolchain::StringMap<std::unique_ptr<Tool>> tool_set;
