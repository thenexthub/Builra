...
#ifndef BUILRA_BASIC_PLATFORMUTILITY_H
#define BUILRA_BASIC_PLATFORMUTILITY_H
...
builra_rlim_t getOpenFileLimit();
...
int raiseOpenFileLimit(builra_rlim_t limit = 2048);
