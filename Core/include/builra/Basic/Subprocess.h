...
#ifndef BUILRA_BASIC_SUBPROCESS_H
#define BUILRA_BASIC_SUBPROCESS_H
...
namespace builra {
  namespace basic {
    ...
    class ProcessGroup {
      ProcessGroup(const ProcessGroup&) BUILRA_DELETED_FUNCTION;
      void operator=(const ProcessGroup&) BUILRA_DELETED_FUNCTION;
      ProcessGroup& operator=(ProcessGroup&&) BUILRA_DELETED_FUNCTION;
    ...
    public:
      ...
      virtual void processStarted(ProcessContext* ctx, ProcessHandle handle, builra_pid_t pid) = 0;
