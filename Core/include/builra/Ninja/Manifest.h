...
#ifndef BUILRA_NINJA_MANIFEST_H
#define BUILRA_NINJA_MANIFEST_H
...
class Scope {
  ...
  toolchain::StringMap<std::string> entries;
  ...
  // inside the rule.
  typedef toolchain::StringMap<Rule*> rule_set;
  rule_set rules;
...
public:
  ...
  const toolchain::StringMap<std::string>& getBindings() const {
    return entries;
  }
...
private:
  ...
  toolchain::StringMap<std::string> parameters;
...
public:
  ...
  toolchain::StringMap<std::string>& getParameters() {
    return parameters;
  }
  const toolchain::StringMap<std::string>& getParameters() const {
    return parameters;
  }
...
class Manifest {
  ...
  // FIXME: This is an inefficent map, given that the string is contained
  // inside the node.
  typedef toolchain::StringMap<Node*> node_set;
  node_set nodes;
  ...
  // FIXME: This is an inefficent map, given that the string is contained
  // inside the pool.
  typedef toolchain::StringMap<Pool*> pool_set;
  pool_set pools;
