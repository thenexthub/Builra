...
#define TOOLCHAIN_ENABLE_DIA_SDK 0
...
#if (defined(__APPLE__) && TARGET_OS_IPHONE) || defined(__ANDROID__) || defined(BUILRA_NO_TERMINFO)
#undef HAVE_TERMINFO
#else
...
#define TOOLCHAIN_ENABLE_ZLIB 1

/* Define if overriding target triple is enabled */
/* #undef TOOLCHAIN_TARGET_TRIPLE_ENV */

/* TOOLCHAIN version information */
/* #undef TOOLCHAIN_VERSION_INFO */

/* Whether tools show host and target info when invoked with --version */
#define TOOLCHAIN_VERSION_PRINTER_SHOW_HOST_TARGET_INFO 1

/* Define if libxml2 is supported on this platform. */
#define TOOLCHAIN_LIBXML2_ENABLED 1
...
#define PACKAGE_NAME "TOOLCHAIN"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TOOLCHAIN 7.0.0svn"
...
#define TOOLCHAIN_GISEL_COV_ENABLED 0

/* Define to the default GlobalISel coverage file prefix */
/* #undef TOOLCHAIN_GISEL_COV_PREFIX */
