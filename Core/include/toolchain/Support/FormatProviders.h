//===- FormatProviders.h - Formatters for common TOOLCHAIN types -----*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements format providers for many common TOOLCHAIN types, for example
// allowing precision and width specifiers for scalar and string types.
//
//===----------------------------------------------------------------------===//

#ifndef TOOLCHAIN_SUPPORT_FORMATPROVIDERS_H
#define TOOLCHAIN_SUPPORT_FORMATPROVIDERS_H
