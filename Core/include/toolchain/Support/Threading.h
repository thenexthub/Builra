...
//===----------------------------------------------------------------------===//
//
// This file declares helper functions for running TOOLCHAIN in a multi-threaded
// environment.
//
//===----------------------------------------------------------------------===//

#ifndef TOOLCHAIN_SUPPORT_THREADING_H
#define TOOLCHAIN_SUPPORT_THREADING_H

#include "toolchain/ADT/SmallVector.h"
#include "toolchain/Config/toolchain-config.h" // for TOOLCHAIN_ON_UNIX
...
#define TOOLCHAIN_THREADING_USE_STD_CALL_ONCE 1
...
#define TOOLCHAIN_THREADING_USE_STD_CALL_ONCE 1
#else
#define TOOLCHAIN_THREADING_USE_STD_CALL_ONCE 0
#endif

#if TOOLCHAIN_THREADING_USE_STD_CALL_ONCE
#include <mutex>
#else
#include "toolchain/Support/Atomic.h"
#endif

namespace toolchain {
class Twine;

/// Returns true if TOOLCHAIN is compiled with support for multi-threading, and
/// false otherwise.
...
void llvm_execute_on_thread(void (*UserFn)(void *), void *UserData,
  ...
  /// Returns 1 when TOOLCHAIN is configured with TOOLCHAIN_ENABLE_THREADS=OFF
