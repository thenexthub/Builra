...
/// of these conform to an TOOLCHAIN "Allocator" concept which consists of an
/// Allocate method accepting a size and alignment, and a Deallocate accepting
/// a pointer and size. Further, the TOOLCHAIN "Allocator" concept has overloads of
...
/// Allocate() methods of TOOLCHAIN-style allocators.
///
/// This base class both documents the full public interface exposed by all
/// TOOLCHAIN-style allocators, and redirects all of the overloads to a single core
...
public:
  ...
  TOOLCHAIN_ATTRIBUTE_RETURNS_NONNULL void *Allocate(size_t Size,
                                                size_t /*Alignment*/) {
