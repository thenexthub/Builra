...
#ifndef TOOLCHAIN_SUPPORT_COMMANDLINE_H
#define TOOLCHAIN_SUPPORT_COMMANDLINE_H
...
///===---------------------------------------------------------------------===//
/// SetVersionPrinter - Override the default (TOOLCHAIN specific) version printer
...
///                          which will be called after the basic TOOLCHAIN version
...
#endif // TOOLCHAIN_SUPPORT_COMMANDLINE_H
