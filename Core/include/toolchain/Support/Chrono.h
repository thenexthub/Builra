...
#ifndef TOOLCHAIN_SUPPORT_CHRONO_H
#define TOOLCHAIN_SUPPORT_CHRONO_H
...
TOOLCHAIN_ATTRIBUTE_ALWAYS_INLINE inline std::time_t toTimeT(TimePoint<> TP) {
...
TOOLCHAIN_ATTRIBUTE_ALWAYS_INLINE inline TimePoint<std::chrono::seconds>
...
TOOLCHAIN_ATTRIBUTE_ALWAYS_INLINE inline TimePoint<>
...
#endif // TOOLCHAIN_SUPPORT_CHRONO_H
