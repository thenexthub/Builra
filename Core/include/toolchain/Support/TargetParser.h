...
#ifndef TOOLCHAIN_SUPPORT_TARGETPARSER_H
#define TOOLCHAIN_SUPPORT_TARGETPARSER_H
...
// even if the back-end is not compiled with TOOLCHAIN, plus we need to create a new
