...
#if __has_builtin(__builtin_ctz) || TOOLCHAIN_GNUC_PREREQ(4, 0, 0)
...
#if __has_builtin(__builtin_ctzll) || TOOLCHAIN_GNUC_PREREQ(4, 0, 0)
...
#if __has_builtin(__builtin_clz) || TOOLCHAIN_GNUC_PREREQ(4, 0, 0)
...
#if __has_builtin(__builtin_clzll) || TOOLCHAIN_GNUC_PREREQ(4, 0, 0)
