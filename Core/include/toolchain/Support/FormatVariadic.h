...
//===----------------------------------------------------------------------===//
//
// This file implements the formatv() function which can be used with other TOOLCHAIN
...
#ifndef TOOLCHAIN_SUPPORT_FORMATVARIADIC_H
#define TOOLCHAIN_SUPPORT_FORMATVARIADIC_H

#include "toolchain/ADT/Optional.h"
#include "toolchain/ADT/STLExtras.h"
#include "toolchain/ADT/SmallString.h"
#include "toolchain/ADT/StringRef.h"
#include "toolchain/Support/FormatCommon.h"
#include "toolchain/Support/FormatProviders.h"
...
// above, the output is undefined.  With asserts enabled, TOOLCHAIN will trigger an
...
#endif // TOOLCHAIN_SUPPORT_FORMATVARIADIC_H
