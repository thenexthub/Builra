...
class TOOLCHAIN_NODISCARD Error {
...
/// error class type.
template <class T> class TOOLCHAIN_NODISCARD Expected {
...
/// ErrorHandling.h.
TOOLCHAIN_ATTRIBUTE_NORETURN void report_fatal_error(Error Err,
