...
#ifndef TOOLCHAIN_ADT_APFLOAT_H
#define TOOLCHAIN_ADT_APFLOAT_H
...
struct APFloatBase {
  ...
  static const fltSemantics &IEEEhalf() TOOLCHAIN_READNONE;
  static const fltSemantics &IEEEsingle() TOOLCHAIN_READNONE;
  static const fltSemantics &IEEEdouble() TOOLCHAIN_READNONE;
  static const fltSemantics &IEEEquad() TOOLCHAIN_READNONE;
  static const fltSemantics &PPCDoubleDouble() TOOLCHAIN_READNONE;
  static const fltSemantics &x87DoubleExtended() TOOLCHAIN_READNONE;

  /// A Pseudo fltsemantic used to construct APFloats that cannot conflict with
  /// anything real.
  static const fltSemantics &Bogus() TOOLCHAIN_READNONE;
...
///
/// These additional declarations are required in order to compile TOOLCHAIN with IBM
/// xlC compiler.
