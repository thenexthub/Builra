...
#ifndef TOOLCHAIN_ADT_TRIPLE_H
#define TOOLCHAIN_ADT_TRIPLE_H
...
public:
  ...
  /// Get the (TOOLCHAIN) name of the minimum ARM CPU for the arch we are targeting.
  ///
  ...
  /// getArchTypeForTOOLCHAINName - The canonical type for the given TOOLCHAIN
  /// architecture name (e.g., "x86").
  static ArchType getArchTypeForTOOLCHAINName(StringRef Str);
