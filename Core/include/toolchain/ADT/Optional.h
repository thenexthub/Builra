...
#ifndef TOOLCHAIN_ADT_OPTIONAL_H
#define TOOLCHAIN_ADT_OPTIONAL_H
...
public:
  ...
  const T &getValue() const TOOLCHAIN_LVALUE_FUNCTION { return *getPointer(); }
  T &getValue() TOOLCHAIN_LVALUE_FUNCTION { return *getPointer(); }

  explicit operator bool() const { return Storage.hasVal; }
  bool hasValue() const { return Storage.hasVal; }
  const T *operator->() const { return getPointer(); }
  T *operator->() { return getPointer(); }
  const T &operator*() const TOOLCHAIN_LVALUE_FUNCTION { return *getPointer(); }
  T &operator*() TOOLCHAIN_LVALUE_FUNCTION { return *getPointer(); }

  template <typename U>
  constexpr T getValueOr(U &&value) const TOOLCHAIN_LVALUE_FUNCTION {
...
#endif // TOOLCHAIN_ADT_OPTIONAL_H
