...
#ifndef TOOLCHAIN_ADT_ALLOCATORLIST_H
#define TOOLCHAIN_ADT_ALLOCATORLIST_H

#include "toolchain/ADT/ilist_node.h"
#include "toolchain/ADT/iterator.h"
#include "toolchain/ADT/simple_ilist.h"
...
///
/// Expose a std::list-like interface that owns and uses a custom TOOLCHAIN-style
...
#endif // TOOLCHAIN_ADT_ALLOCATORLIST_H
