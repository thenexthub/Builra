...
#ifndef TOOLCHAIN_ADT_APINT_H
#define TOOLCHAIN_ADT_APINT_H
...
///     not.
///   * In general, the class tries to follow the style of computation that TOOLCHAIN
///     uses in its IR. This simplifies its use for TOOLCHAIN.
///
class TOOLCHAIN_NODISCARD APInt {
public:
...
private:
  ...
  /// out-of-line slow case for operator==
  bool EqualSlowCase(const APInt &RHS) const TOOLCHAIN_READONLY;

  /// out-of-line slow case for countLeadingZeros
  unsigned countLeadingZerosSlowCase() const TOOLCHAIN_READONLY;

  /// out-of-line slow case for countLeadingOnes.
  unsigned countLeadingOnesSlowCase() const TOOLCHAIN_READONLY;

  /// out-of-line slow case for countTrailingZeros.
  unsigned countTrailingZerosSlowCase() const TOOLCHAIN_READONLY;

  /// out-of-line slow case for countTrailingOnes
  unsigned countTrailingOnesSlowCase() const TOOLCHAIN_READONLY;

  /// out-of-line slow case for countPopulation
  unsigned countPopulationSlowCase() const TOOLCHAIN_READONLY;

  /// out-of-line slow case for intersects.
  bool intersectsSlowCase(const APInt &RHS) const TOOLCHAIN_READONLY;

  /// out-of-line slow case for isSubsetOf.
  bool isSubsetOfSlowCase(const APInt &RHS) const TOOLCHAIN_READONLY;
  ...
  int compare(const APInt &RHS) const TOOLCHAIN_READONLY;

  /// Signed comparison. Returns -1, 0, or 1 if this APInt is less than, equal
  /// to, or greater than RHS.
  int compareSigned(const APInt &RHS) const TOOLCHAIN_READONLY;
...
// order to compile TOOLCHAIN with IBM xlC compiler.
