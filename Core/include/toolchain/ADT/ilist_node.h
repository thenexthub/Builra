...
#ifndef TOOLCHAIN_ADT_ILIST_NODE_H
#define TOOLCHAIN_ADT_ILIST_NODE_H
...
/// TOOLCHAIN_ENABLE_ABI_BREAKING_CHECKS.  The function \a isKnownSentinel() always
...
#endif // TOOLCHAIN_ADT_ILIST_NODE_H
