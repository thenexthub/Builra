//===-- toolchain/ADT/APSInt.h - Arbitrary Precision Signed Int -----*- C++ -*--===//
//
...
#ifndef TOOLCHAIN_ADT_APSINT_H
#define TOOLCHAIN_ADT_APSINT_H

#include "toolchain/ADT/APInt.h"

namespace toolchain {

class TOOLCHAIN_NODISCARD APSInt : public APInt {
  bool IsUnsigned;
