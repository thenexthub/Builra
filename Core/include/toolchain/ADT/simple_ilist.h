...
#ifndef TOOLCHAIN_ADT_SIMPLE_ILIST_H
#define TOOLCHAIN_ADT_SIMPLE_ILIST_H

#include "toolchain/ADT/ilist_base.h"
#include "toolchain/ADT/ilist_iterator.h"
#include "toolchain/ADT/ilist_node.h"
#include "toolchain/ADT/ilist_node_options.h"
...
/// TOOLCHAIN_ENABLE_ABI_BREAKING_CHECKS are enabled).
...
public:
  ...
  TOOLCHAIN_NODISCARD bool empty() const { return Sentinel.empty(); }

  /// Calculate the size of the list in linear time.
  TOOLCHAIN_NODISCARD size_type size() const {
...
#endif // TOOLCHAIN_ADT_SIMPLE_ILIST_H
